public class Program
{
    static void Main(string[] args)
    {
        ...
        List<Product> products = new List<Product>
        {
            ...
            new Product{ProductId=4, CategoryId=2, ProductName="Samsung Laptop", QuantityPerUnit="6 GB Ram", UnitPrice=50000,UnitsInStock=15},
            new Product{ProductId=5, CategoryId=2, ProductName="Apple Laptop", QuantityPerUnit="4 GB Ram", UnitPrice=80000,UnitsInStock=0},
        };
